...
func GetProviders() map[string]cuexruntime.ProviderFn {
	return map[string]cuexruntime.ProviderFn{
		"create": providertypes.GenericProviderFn[CreateConfigProperties, any](CreateConfig),
		"read":   providertypes.GenericProviderFn[wfconfig.NamespacedName, ReadReturns](ReadConfig),
		"list":   providertypes.GenericProviderFn[ListVars, ListReturns](ListConfig),
		"delete": providertypes.GenericProviderFn[wfconfig.NamespacedName, any](DeleteConfig),
	}
}

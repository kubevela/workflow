...
func main() {
	...
	flag.BoolVar(&wfupgrade.EnableListConcatUpgrade, "cue-upgrade-list-concat-enabled", wfupgrade.EnableListConcatUpgrade, "Enable list concat/list arithmetic compatibility rewrite pass.")
	flag.BoolVar(&wfupgrade.EnableErrorFieldLabelUpgrade, "cue-upgrade-error-field-label-enabled", wfupgrade.EnableErrorFieldLabelUpgrade, "Enable error field-label compatibility rewrite pass.")
	flag.BoolVar(&wfupgrade.EnableBoolDefaultGuardUpgrade, "cue-upgrade-bool-default-guard-enabled", wfupgrade.EnableBoolDefaultGuardUpgrade, "Enable bool default-guard hazard compatibility rewrite pass.")
	flag.BoolVar(&wfupgrade.EnableGenericDefaultGuardUpgrade, "cue-upgrade-generic-default-guard-enabled", wfupgrade.EnableGenericDefaultGuardUpgrade, "Enable generic default-guard hazard compatibility rewrite pass.")
	flag.BoolVar(&wfupgrade.EnableKeepValidatorsSingletonUpgrade, "cue-upgrade-keepvalidators-singleton-enabled", wfupgrade.EnableKeepValidatorsSingletonUpgrade, "Enable keepvalidators singleton concretization compatibility pass.")
	flag.BoolVar(&wfupgrade.EnableEvalv3SelfRefGuardUpgrade, "cue-upgrade-evalv3-selfref-guard-enabled", wfupgrade.EnableEvalv3SelfRefGuardUpgrade, "Enable evalv3 self-reference default-guard compatibility rewrite pass.")

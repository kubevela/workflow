...
{{- $releaseNamespace = index $existing.metadata.annotations "meta.helm.sh/release-namespace" | default "" -}}
{{- end -}}
{{- if or (not $existing) (and (eq $releaseName $root.Release.Name) (eq $releaseNamespace $root.Release.Namespace)) -}}true{{- end -}}
{{- end -}}
